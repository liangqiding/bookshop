...
public class AppSecurityConfigurer extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	.antMatchers("/AjaxCartPay","/AjaxCartOrder","/AjaxCart","/successOK","/AjaxOrderP","/LoginAjax","/success","/personal","/pay","buy","/page","/selectclass","/SelectAjax","/index",
				"/UserAjax","/basic/**","/AmazeUI-2.4.2/**","/images/**","/","/BorrowBackAJAX","/BorrowBack",
				"/cardmanage","/Bcards","/CardAjax","/BorrowAjax","/UpdateBooks",
				"/selectbook","/select","/returnbookstudent","logout","/register","/login",
				"/css/**","/js/**","/img/**","/fonts/**","/usermanage","/Book","return").permitAll()
	  	.antMatchers( "/home").hasRole("USER")
	  	.antMatchers("/book","/upload","/update","/updatemain").hasAnyRole("ADMIN")
//	  	STUDENT
	  	.antMatchers("/bookstudent","/borrowmain").hasAnyRole("STUDENT","ADMIN")
